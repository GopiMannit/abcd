    ...
    <div className="bg-custom-image">
      ...
      <div className="flex flex-row justify-end items-center h-screen">
        <form onSubmit={handleSubmit}>
          <div className="flex flex-col mt-5 h-[475px] w-[350px] sm:w-full sm:max-w-sm md:w-[450px] md:max-w-md lg:w-[350px] lg:max-w-lg lg:mr-36 mx-4 items-center  mr-1 sm:mr-0 bg-[#FDD116] rounded-2xl shadow-5xl border-r-0 border-b-0 border-opacity-30 ">
