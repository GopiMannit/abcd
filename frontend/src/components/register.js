          ...
          <div className="flex flex-col mt-3 pb-3  h-full w-[350px] items-center bg-[#FDD116] rounded-3xl shadow-5xl border-r-0 border-b-0 border-opacity-30">
            ...
            <div className="flex flex-col space-y-[24px] mt-5">
              ...
              <div className="flex flex-row space-x-3">
                ...
                <input value={msgCount} onChange={e => msgCountChange(e.target.value)} type="number" placeholder='Message Count' className="w-[220px] text-sm text-[#28282B]  placeholder-[#28282B] bg-transparent focus:outline-none border-b-[1px] border-[#28282B] " inputMode='numeric'/>
              </div>
              <div className="flex flex-row space-x-3">
