...
function Login({ selectedMenu, setSelectedMenu }) {
  ...
  // Install button functionality for PWA installation
    ...
    <div className="min-h-screen bg-custom-image ">
      <div>
        <nav className="bg-[#FDD116]">
          <div className="flex flex-row  items-center justify-between p-2 space-x-2 sm:flex flex-row sm:item-center">
            <img className="h-18 w-18 p-2 rounded-full shadow-[0px_0px_15px] shadow-white sm:mx-0 block" src={logo} />
            <button onClick={installApp} className="bg-black justify-end hover:bg-black-700 text-white font-bold py-2 px-4 rounded">
          Install
        </button>
        ...
        <div className=''>
          <div className="flex flex-col items-center justify-center mt-28 sm:flex-row ">
            <div className="title flex flex-col items-center gap-1 mr-12 mt-15 sm:mr-10 ml-10 mt-15 md:mr-10 flex flex-col">
              <img src={globe} width={300} height={300} />
              <h1 id="titleText">
              {/* this lines are for annimation of INNOVATE , ACCELERATE , CREATE WITH MANNIT  */}
                <div className="space-x-6 sm:space-x-6 flex flex-col">
                  <div className='sm:space-x-6'>
                    <div className='transform-text sm:mr-10 ml-10'>
            ...
            <div className="sm:w-5xl sm:bg-5xl md:w-6xl h-[400px] w-[320px] bg-[#FDD116] rounded-2xl shadow-5xl border-r-0 border-b-0 border-opacity-30">
